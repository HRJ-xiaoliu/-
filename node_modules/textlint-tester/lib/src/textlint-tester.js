    ...
    return {
        lintText(text, ext) {
            return __awaiter(this, void 0, void 0, function* () {
                return kernel.lintText(text, Object.assign({ ext }, textlintKernelDescriptor.toKernelOptions()));
            });
        },
        lintFile(filePath) {
            return __awaiter(this, void 0, void 0, function* () {
                const text = yield promises_1.default.readFile(filePath, "utf-8");
                const ext = path_1.default.extname(filePath);
                return kernel.lintText(text, Object.assign({ ext,
                    filePath }, textlintKernelDescriptor.toKernelOptions()));
            });
        },
        fixText(text, ext) {
            return __awaiter(this, void 0, void 0, function* () {
                return kernel.fixText(text, Object.assign({ ext }, textlintKernelDescriptor.toKernelOptions()));
            });
        },
        fixFile(filePath) {
            return __awaiter(this, void 0, void 0, function* () {
                const text = yield promises_1.default.readFile(filePath, "utf-8");
                const ext = path_1.default.extname(filePath);
                return kernel.fixText(text, Object.assign({ ext,
                    filePath }, textlintKernelDescriptor.toKernelOptions()));
            });
        }
    };
...
class TextLintTester {
    ...
    testValidPattern(testName, param, valid) {
        ...
        const textlint = createTestLinter(createTextlintKernelDescriptor({
            testName,
